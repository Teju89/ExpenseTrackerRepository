...
<body style="overflow-y: hidden;">
    ...
    <div class="contact1" style="background-image: radial-gradient( blue , maroon 80%);">
        <div class="container-contact1" style="background-color: rgb(164, 98, 231,0.3);">
            <div class="contact1-pic js-tilt" data-tilt>
                <img src="media/expense.png" alt="IMG">
            </div>

            <form class="contact1-form validate-form" action="UpdateExpense">
                ...
                <div class="wrap-input1 validate-input" data-validate="Message is required">
                    <textarea class="input1" name="description" placeholder="Description">
